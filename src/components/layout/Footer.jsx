      ...
      <footer className="bg-gray-900 text-white">
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-400 hover:text-white">Custom Software Development</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white">SaaS Development</a></li>
                ...
                <li><a href="#" className="text-gray-400 hover:text-white">DevOps & Automation</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white">AI & Machine Learning</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-400 mb-4">
                Subscribe to our newsletter for the latest updates on technology trends and Intelion news.
              </p>
              <form className="flex">
                <input
                  type="email"
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400">© 2025 Intelion. All rights reserved.</p>
